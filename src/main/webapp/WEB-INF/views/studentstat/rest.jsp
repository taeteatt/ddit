...
<p style="display:none;"><sec:authentication property="principal.userInfoVO.authorityVOList"  var="myAuths"/></p>
	...
	<div class="expBox" style="color:black;">
		<strong>
			...
			<br>
			<p>
				1. 「 휴학신청 → 상담 → 승인대기 → 승인 」단계 절차로 이루어집니다.
			</p>
			<br>
			<p>
				2. 반려 가능성이 있습니다.
            ...
            <table class="table table-hover text-nowrap">
                ...
                <tbody id="trShow">
                    <tr name="trHref" data-toggle="modal" data-target="#modalDetail" style="cursor:pointer">
                        ...
                        <td class="textCenter">2024-06-25 11:41</td>
                        <td class="textCenter">2024-07-01 ~ 2025-02-28</td>
                        <td class="textCenter" style="color: #afabab;">대기</td>
                    </tr>
                    <tr name="trHref" style="cursor:pointer">
                        <td class="textCenter">2</td>
                        <td class="textCenter">2023-06-20 10:02</td>
                        <td class="textCenter">2023-07-01 ~ 2023-12-28</td>
                        <td class="textCenter" style="color: red;">반려</td>
                    </tr>
                    <tr name="trHref" style="cursor:pointer">
                        <td class="textCenter">3</td>
                        <td class="textCenter">2022-06-02 16:24</td>
                        <td class="textCenter">2022-08-01 ~ 2023-02-28</td>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body flex">
					<p>
						<div>휴학 일자</div>
						<input type="date" class="form-control pull-right pickers mSpan" id="datepickerssDetail1" name="datepickerssDetail" value="2024-07-01" disabled>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ~ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="date" class="form-control pull-right pickers mSpan" id="datepickerssDetail2" name="datepickerssDetail" value="2025-02-28" disabled>
					</p>
					<p>
						<span class="mSpan">담당 교수</span>
						<span>
					...
					<p>
						<span class="mSpan">휴학 사유</span>
						<span>
							<textarea rows="5" id="textareaDetail" class="form-control textAreaMar" disabled>건강 상 문제</textarea>
						</span>
					</p>
					<p>
			            <div class="custom-file">
			                <input type="file" name="queAttFile" class="custom-file-input" id="customFileDetail" multiple disabled/>  <!-- input,label 순서 고정 -->
			                <label class="custom-file-label" for="customFile">병원 진료 확인서</label>
			            </div>
					</p>
				</div>
				<div class="modal-footer">
