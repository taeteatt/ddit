    ...
    <div class="card">
        <div class="card-header" class="divCardHeader" style="background-color: #fff;">
            <div class="brd-search">
                ...
                <button type="button" name="authorityBtn" class="btn btn-block btn-outline-primary wkrtjdBut" data-toggle="modal" data-target="#modalCreate">신청</button>
            </div>
        </div>
            ...
            <table class="table table-hover text-nowrap">
                ...
                <tbody id="trShow">
                    <tr name="trHref" data-toggle="modal" data-target="#modalDetail" style="cursor:pointer">
                        ...
                        <td class="textCenter">2022-01-12 16:07</td>
                        <td class="textCenter">2022-03-01</td>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">자퇴 신청 상세정보</h5>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body flex">
					<p>
						<div>자퇴 일자</div>
						<input type="date" class="form-control pull-right pickers mSpan" id="datepickerssDetail1" name="datepickerssDetail" value="2022-03-01" disabled>
					</p>
					<p>
						<span class="mSpan">담당 교수</span>
						<span>
					...
					<p>
						...
						<span>
							<textarea rows="5" id="textareaDetail" class="form-control textAreaMar" disabled>건강 관련하여 게속해서 수업을 들을 수 없어 자퇴를 희망합니다.</textarea>
						</span>
					</p>
					<p>
			            <div class="custom-file">
			                <input type="file" name="queAttFile" class="custom-file-input" id="customFileDetail" multiple disabled/>  <!-- input,label 순서 고정 -->
			                <label class="custom-file-label" for="customFile">소견서</label>
			            </div>
					</p>
				</div>
				<div class="modal-footer">
