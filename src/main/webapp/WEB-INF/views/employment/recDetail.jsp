	...
	$(function() {
		...
		$('#list').on('click', function() {
			if (dataRole.includes("STUDENT")) {
				location.href = "/employment/recruitment?menuId=cybJobHun";
			}
			if (dataRole.includes("PROFESSOR")) {
				location.href = "/employment/recruitment?menuId=proEmpSup";
			}
		});
								...
								<form id="frm" name="frm" action="#" method="post" enctype="multipart/form-data">
									<div class="card-body">
										<div class="hea">
											...
											<p>
												<input type="text" id="subject" class="form-control" name="recuTitle" style="width: 510px;height: 39px;"
	...
	function fRecDetailDispAjax(data){
		$.ajax({
			...
			success:function(result){
				...
				// console.log("result",result.comAttachDetVOList)
				...
				<div class="card-footer cardFooterDiv">
					<div class="btnbtn">
						...
						<p id="p2" style="display: none;">
							<button type="button"
								class="btn btn-block btn-outline-warning btncli" id="btnSave">확인</button>
							<button type="button"
