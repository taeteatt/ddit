...
$(function () {
   ...
   let temp = document.getElementsByName("trHref").href;
    ...
    $('#newwrite').on('click', function(){
		location.href = "/employment/recCreateAdmin?menuId=manRecRui";	
	});
      ...
      success:function(result){
        console.log("result>>",result)
         ...
         $.each(result.content, function(idx, recruitmentVO){
            ...
            str += `<tr name="trHref" onclick="location.href='/employment/recDetailAdmin?menuId=manRecRui&recuNo=\${recruitmentVO.recuNo}'" style="cursor:pointer">`;
            ...
            <table class="table table-hover text-nowrap">
                ...
                <tbody id="trShow">
                    <c:forEach var="recruitmentVO" items="${articlePage.content}" varStatus="stat">
                        <!-- ${recruitmentVO} -->
                            <sec:authorize access="hasRole('ROLE_ADMIN')">
                                <tr name="trHref" onclick="location.href='/employment/recDetailAdmin?menuId=manRecRui&recuNo=${recruitmentVO.recuNo}'" style="cursor:pointer">
                            </sec:authorize>
