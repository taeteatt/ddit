...
<div class="col-12 card card-outline card-info">
	...
	<div id="Wrapper" style="display:flex;">
	    <div class="col-6">
			<h5 style="margin-left:10px; margin-bottom:20px">학사일정</h5>
	    ...
	    <div id='notice' class="col-6" style="margin-bottom:20px;">
	    	<div style="display:flex; align-items: baseline;">
		    	<h5 style=" margin-bottom: 20px;">공지사항</h5>
		    	<h6 style="margin-left:570px; cursor:pointer;" onclick='location.href="/commonNotice/listStu?menuId=denAnnIce"'>더보기 +</h6>
	    	</div>
	    			...
	    			<thead>
	   				...
	   				<tbody>
	   					<c:forEach var="noticeVO" items="${noticeList}" varStatus="stat">
			    			<tr onclick="location.href='/commonNotice/detailStu?menuId=denAnnIce&comNotNo=${noticeVO.comNotNo}'" style="cursor:pointer;">	
