...
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
					<tr name="trHref" data-toggle="modal" data-target="#modalDetail" style="cursor:pointer">
						...
						<td class="textCenter">20201387</td>
						<td class="textCenter">강건우</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">4학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-1380-7530</td>
					</tr>
					<tr name="trHref" style="cursor:pointer">
						<td class="textCenter">2</td>
						<td class="textCenter">20210011</td>
						<td class="textCenter">금호석</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">4학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-1235-0031</td>
					</tr>
					<tr name="trHref" style="cursor:pointer">
						<td class="textCenter">3</td>
						<td class="textCenter">20170338</td>
						<td class="textCenter">박재광</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">4학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-1113-3218</td>
					</tr>
					<tr name="trHref" style="cursor:pointer">
						<td class="textCenter">4</td>
						<td class="textCenter">20211817</td>
						<td class="textCenter">도지한</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">3학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-7835-1594</td>
					</tr>
					<tr name="trHref" style="cursor:pointer">
						<td class="textCenter">5</td>
						<td class="textCenter">20220900</td>
						<td class="textCenter">문지후</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">2학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-8520-8751 </td>
					</tr>
					<tr name="trHref" style="cursor:pointer">
						<td class="textCenter">6</td>
						<td class="textCenter">20230118</td>
						<td class="textCenter">서경수</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">1학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-3485-7730</td>
					</tr>
					<tr name="trHref" style="cursor:pointer">
						<td class="textCenter">7</td>
						<td class="textCenter">20224813</td>
						<td class="textCenter">연우진</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">2학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-8766-9076</td>
					</tr>
					<tr name="trHref" style="cursor:pointer">
						<td class="textCenter">8</td>
						<td class="textCenter">20212708</td>
						<td class="textCenter">송유하</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">4학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-8721-3918</td>
					</tr>
					<tr name="trHref" style="cursor:pointer">
						<td class="textCenter">9</td>
						<td class="textCenter">20221887</td>
						<td class="textCenter">오경수</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">3학년</td>
						<td class="textCenter">휴학</td>
					...
					<tr name="trHref" style="cursor:pointer">
						...
						<td class="textCenter">20223303</td>
						<td class="textCenter">이승일</td>
						<td class="textCenter">컴퓨터공학과</td>
						<td class="textCenter">3학년</td>
						<td class="textCenter">휴학</td>
						<td class="textCenter">010-8520-2851</td>
					</tr>
<%-- 					</c:forEach> --%>
				</tbody>
			</table>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content" style="width: 600px;">
				<div class="modal-header">
					<h5 class="modal-title" id="consultingModalLabel">복학 신청서 상세 내용</h5>
				...
				<div class="modal-body">
					<form>
						<div class="form-group stustu">
							...
							<input type="text" class="form-control" id="stno" style="width: 277px" value="20201387" readonly>
						</div>
						&nbsp;
						<div class="form-group stustu">
							<label for="modalname">이름</label>
							<input type="text" class="form-control" id="name" style="width: 277px" value="강건우" readonly>
						</div>
						<div class="form-group stustu">
						...
						<div class="form-group stustu">
							...
							<input type="text" class="form-control" id="Time" value="2024-06-30" style="width: 277px" readonly>
						</div>

						<div class="form-group">
							<label for="modalcontent">복학 사유</label>
