	...
	$.ajax({
		...
		success:function(result){
			...
			$.each(result.content, function(idx, CommonNoticeVO){
				str += `<tr name="trHref" onclick="location.href='/commonNotice/detailStu?menuId=denAnnIce&comNotNo=\${CommonNoticeVO.comNotNo}'" style="cursor:pointer">
...
<%-- 					${CommonNoticeVO} --%>
					<tr id="trHref" onclick="location.href='/commonNotice/detailStu?menuId=denAnnIce&comNotNo=${CommonNoticeVO.comNotNo}'" style="cursor:pointer">
						<td class="textCenter">${CommonNoticeVO.rn}</td>
						<td class="textCenter">${CommonNoticeVO.comGubun}</td>
						<td>${CommonNoticeVO.comNotName}</td>
						<td class="textCenter">${CommonNoticeVO.userInfoVOList.userName}</td>
