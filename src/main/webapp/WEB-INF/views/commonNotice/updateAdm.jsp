...
<%-- ${commonNoticeVO} --%>
    <form id="frm" name="frm" action="/commonNotice/updateAdm?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
        <div class="card-body">
            <div class="hea">
...
$(function(){
    ...
    console.log("comNo", comNo);
    	location.href = `/commonNotice/detailAdm?menuId=manNotIce&comNotNo=\${comNo}`;
    });
