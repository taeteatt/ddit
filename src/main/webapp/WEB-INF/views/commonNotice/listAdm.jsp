...
$(function () {
	...
	$('#newwrite').on('click', function(){
		location.href = "/commonNotice/createAdm?menuId=manNotIce";	
	});
	...
	$.ajax({
		...
		success:function(result){
			...
			$.each(result.content, function(idx, CommonNoticeVO){
				str += `<tr name="trHref" onclick="location.href='/commonNotice/detailAdm?menuId=manNotIce&comNotNo=\${CommonNoticeVO.comNotNo}'" style="cursor:pointer">`;
				...
				str += `<td class="textCenter">\${CommonNoticeVO.comFirstDate}</td>`;
...
<%-- 					${CommonNoticeVO} --%>
					<tr id="trHref" onclick="location.href='/commonNotice/detailAdm?menuId=manNotIce&comNotNo=${CommonNoticeVO.comNotNo}'" style="cursor:pointer">
