...
<h3>분실물 게시판</h3>
<div class="lostItemBox" style="color:black;">
   <p><strong>
...
<!-- 	<form> -->
		...
		<input type="button" class="btn btn-outline-primary col-1" value="작 성" style="float: inline-end;" onclick='location.href="/timePost/lostItemAdd?menuId=injlosIte"'>
	</div>
		...
		<table class="table table-hover text-nowrap">
			<thead>
				<tr class="trBackground textCenter"style="color:black;">
					...
					<th style="width: 10%;">회수 여부</th>
				</tr>
			</thead>
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=1'" style="cursor:pointer">
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=2'" style="cursor:pointer">
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=3'" style="cursor:pointer">
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=4'" style="cursor:pointer">
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=5'" style="cursor:pointer">
					<td class="textCenter">5</td>
					<td>인형 두고가신분</td>
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=6'" style="cursor:pointer">
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=7'" style="cursor:pointer">
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=8'" style="cursor:pointer">
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=9'" style="cursor:pointer">
...
<%-- 					</c:forEach> --%>
			...
			<tbody id="trShow">
<%-- 					<c:forEach var="CommonNoticeVO" items="${articlePage.content}" varStatus="stat"> --%>
				<tr name="trHref" onclick="location.href='/timePost/lostItemDetail?menuId=injlosIte&timeLoNo=10'" style="cursor:pointer">
