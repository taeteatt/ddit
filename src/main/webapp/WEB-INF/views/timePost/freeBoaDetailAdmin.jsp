...
$(function() {
   ...
   $('#list').on('click', function() {
      location.href = "/timePost/freeBoardAdmin?menuId=jaeFreBoA";
   });
	...
	<div>
		...
		<div class="mainbdFoot card card-primary card-outline">
			...
			<table class="commentBor tableMarginTop">
				...
				<tr class="commentBor" style="background-color: #ebf1e9">
					<td class="tdPaddingNic" style="width: 80%;">익명2</td>
				...
				<tr class="commentBor">
					...
					<!--                </td> -->
					<td class="tdPaddingBut">
						<button type="button" class="btn btn-block btn-outline-danger btn-xs btncliDecl" id="decl">블라인드</button>					</td>
					</tr>
				<tr class="commentBor">
					<td class="tdPaddingNic" colspan="3">
