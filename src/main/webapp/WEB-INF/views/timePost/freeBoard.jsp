...
<!-- 	<form> -->
			<div class="brd-search">
				...
				<button type="button" name="newwrite" class="btn btn-block btn-outline-primary wkrtjdBut" id="newwrite">작성</button>
			</div>
<!-- 	</form> -->
		</div>
		...
		<div class="card-body table-responsive p-0">
			...
			<tbody id="trShow">
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=1'" style="cursor:pointer">
				    ...
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=2'" style="cursor:pointer">
				        <td class="textCenter">2</td>
				        <td class="textCenter"style="text-align: left;">기숙사생들 오늘 저녁에 치킨먹을사람 구함.</td>
				        <td class="textCenter">2024-07-14</td>
				        <td class="textCenter">61</td>
				    </tr>
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=3'" style="cursor:pointer">
				    ...
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=4'" style="cursor:pointer">
				    ...
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=5'" style="cursor:pointer">
				        <td class="textCenter">5</td>
				        <td class="textCenter"style="text-align: left;">내일  과 시험 벼락치기로 도서관가서 같이 할사람 </td>
				        <td class="textCenter">2024-07-13</td>
				        <td class="textCenter">88</td>
				    </tr>
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=6'" style="cursor:pointer">
				        <td class="textCenter">6</td>
				        <td class="textCenter"style="text-align: left;">정보처리 기사 꿀팁 정보 공유 함</td>
				        <td class="textCenter">2024-07-13</td>
				        <td class="textCenter">102</td>
				    </tr>
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=7'" style="cursor:pointer">
				        <td class="textCenter">7</td>
				        <td class="textCenter"style="text-align: left;">[정보]제주 삼다수는 화산 암반수임 </td>
				        <td class="textCenter">2024-07-13</td>
				        <td class="textCenter">160</td>
				    </tr>
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=8'" style="cursor:pointer">
				    ...
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=9'" style="cursor:pointer">
				        <td class="textCenter">9</td>
				        <td class="textCenter"style="text-align: left;">오버워치 2는 사실 없던거야 </td>
				        <td class="textCenter">2024-07-12</td>
				        <td class="textCenter">220</td>
				    </tr>
				    <tr name="trHref" onclick="location.href='/timePost/freeBoaDetail?menuId=injFreArd=10'" style="cursor:pointer">
