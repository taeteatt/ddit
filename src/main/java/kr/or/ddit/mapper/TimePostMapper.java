...
public interface TimePostMapper {
	...
	public int lecBoaDelete(TimeLecutreBoastVO timeLecutreBoastVO);
	...
	public int boaLikeUpdate(TimeLectureRecomVO timeLectureRecomVO);

	public int boaLikeDelete(TimeLectureRecomVO timeLectureRecomVO);
